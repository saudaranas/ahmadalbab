...
<footer>
  <div class="wrap footer-row">
    <div class="footer-brand-col footer-meta" style="flex-direction:column;gap:10px;align-items:flex-start;">
      ...
      <p style="margin:0;">Review Produk Shopee &amp; Tiktok Untuk Anda!</p>
      <p style="margin:0;">© ${year} ahmadalbab. Hak Cipta Terpelihara.</p>
    ...
    <div>
      ...
      <p class="footer-placeholder">Akan datang</p>
    </div>
    <div>
